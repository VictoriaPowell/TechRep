<?php
include 'connect.php';
$_SESSION['ref'] = "index_technician.php";
...
<div id="header">
    <div class="wrapper">
        <div class="fl_left">
            <h1>
                <a href="index_technician.php"><img src="images/logo.jpg" title="Tech Rep" alt="Tech Rep" width="260" height="80" border="0" /></a>
            </h1>
        </div>
        <div class="fl_right">
            <?php
...
<div id="topbar">
    <div class="wrapper">
        <div id="topnav">
            <ul>
                <li class="active"><a href="index_technician.php">Home</a></li>
                <li><a href="pages/profile_technician.php">Profile</a></li>
                <li><a href="pages/services_technician.php">Services</a></li>
                <li><a href="pages/product_main_technician.php">Products</a>
                    <ul>
<!--                        <li><a href="pages/product_comps_technician.php">Computers</a></li>-->
                        <li><a href="pages/product_hardware_technician.php">Hardware</a></li>
                        <li><a href="pages/product_software_technician.php">Software</a></li>
                    </ul>
                </li>
<!--                <li class="last"><a href="pages/locations_technician.php">Locations</a></li>-->
            </ul>
        </div>
        <div id="search">
            ...
            <ul id="accordion">
                <li class="current">
                    <div class="featured_box">
                        ...
                        <p class="readmore"><a href="pages/profile_technician.php">Go Now &raquo;</a></p>
                    </div>
                ...
                <li>
                    <div class="featured_box">
                        ...
                        <p class="readmore"><a href="pages/product_main_technician.php">Go Now &raquo;</a></p>
                    </div>
                ...
                <li>
                    <div class="featured_box">
                        ...
                        <p>View your service history. View your commision and any notes about the service along with the rating given by the customer.</p>
                        <p class="readmore"><a href="pages/services_technician.php">Go Now &raquo;</a></p>
                    </div>
