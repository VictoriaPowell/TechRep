...
include '../connect.php';
$_SESSION['ref'] = "product_hardware_technician.php"?>
    ...
    <div class="wrapper">
        <div id="topnav">
            <ul>
                ...
                <li><a href="profile_technician.php">Profile</a></li>
                <li><a href="services_technician.php">Services</a></li>
                <li><a href="product_main_technician.php">Products</a>
                    <ul>
                        <li class="active"><a href="product_hardware_technician.php">Hardware</a></li>
...
<div id="breadcrumb">
    <div class="wrapper">
        <ul>
            ...
            <li><a href="../index_technician.php">Home</a></li>
            <li>&#187;</li>
            <li><a href="product_main_technician.php">Product</a></li>
            <li>&#187;</li>
            <li class="current"><a href="#">Hardware</a></li>
        </ul>
    </div>
</div>
<!-- ####################################################################################################### -->
    ...
    <div class="wrapper">
        ...
        <div id="search">
            <table style="width:400px; margin-left:auto; margin-right:auto;">
                <thead>
                <tr>
                    <th colspan="2">Hardware Search</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                ...
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <button type="button" id="SubmitButton" onclick="searchHardware()">Search</button>
                    </td>
                </tr>
                </tbody>
            </table>
