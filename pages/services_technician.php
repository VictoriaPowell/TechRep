...
include '../connect.php';
$_SESSION['ref'] = "services_technician.php"?>
    ...
    <div class="wrapper">
        <div id="topnav">
            <ul>
                ...
                <li class="active"><a href="services_technician.php">Services</a></li>
            ...
            <table style="width:400px; margin-left:auto; margin-right:auto;">
                ...
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <button type="button" id="SubmitButton" onclick="searchServices()">Search</button>
                    </td>
                </tr>
                </tbody>
            </table>
