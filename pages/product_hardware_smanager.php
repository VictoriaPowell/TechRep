...
include '../connect.php';
$_SESSION['ref'] = "product_hardware_smanager.php"?>
        ...
        <div id="topnav">
            <ul>
                ...
                <li><a href="product_main_smanager.php">Products</a>
                    <ul>
                        <li class="active"><a href="product_hardware_smanager.php">Hardware</a></li>
...
<div id="breadcrumb">
    <div class="wrapper">
        <ul>
            ...
            <li><a href="../index_smanager.php">Home</a></li>
            <li>&#187;</li>
            <li><a href="product_main_smanager.php">Product</a></li>
            <li>&#187;</li>
