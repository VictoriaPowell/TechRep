...
$_SESSION['ref'] = "technicians_smanager.php"?>
...
<head>
    <title>TechRep | Technicians</title>
    ...
    <div class="wrapper">
        <div id="topnav">
            <ul>
                ...
                <li class="active"><a href="technicians_smanager.php">Technicians</a></li>
...
<div id="breadcrumb">
    <div class="wrapper">
        <ul>
            ...
            <li><a href="../index_smanager.php">Home</a></li>
            <li>&#187;</li>
            <li class="current"><a href="#">Technicians</a></li>
        </ul>
    </div>
</div>
<!-- ####################################################################################################### -->
    ...
    <div class="wrapper">
        ...
        <div id="search">
            <table style="width:400px; margin-left:auto; margin-right:auto;">
                <thead>
                <tr>
                    <th colspan="2">Technicians Search</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                ...
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <button type="button" id="SubmitButton" onclick="searchTechnicians()">Search</button>
                    </td>
                </tr>
                </tbody>
            </table>
