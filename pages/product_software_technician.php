...
include '../connect.php';
$_SESSION['ref'] = "product_software_technician.php"?>
...
<head>
    <title>TechRep | Product-Software</title>
            ...
            <ul>
                ...
                <li><a href="product_main_technician.php">Products</a>
                    <ul>
                        ...
                        <li class="active"><a href="product_software_technician.php">Software</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <div class="wrapper">
        ...
        <div id="search">
            <table style="width:400px; margin-left:auto; margin-right:auto;">
                <thead>
                <tr>
                    <th colspan="2">Software Search</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                ...
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <button type="button" id="SubmitButton" onclick="searchSoftware()">Search</button>
                    </td>
                </tr>
                </tbody>
            </table>
