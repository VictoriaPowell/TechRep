...
$_SESSION['ref'] = "revenue_smanager.php"?>
    ...
    <div class="wrapper">
        <div id="topnav">
            <ul>
                ...
                <li class="active"><a href="revenue_smanager.php">Revenue</a></li>
...
<div id="breadcrumb">
    <div class="wrapper">
        <ul>
            ...
            <li><a href="../index_smanager.php">Home</a></li>
            <li>&#187;</li>
            <li class="current"><a href="#">Revenue</a></li>
        </ul>
    </div>
</div>
<!-- ####################################################################################################### -->
<div id="container">
    <div class="wrapper">
        <?php include "tables/revenue_table_smanager.php"; ?>
    </div>
</div>
<div id="copyright">
    <div class="wrapper">
