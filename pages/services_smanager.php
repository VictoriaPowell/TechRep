...
include '../connect.php';
$_SESSION['ref'] = "services_smanager.php"?>
    ...
    <div class="wrapper">
        <div id="topnav">
            <ul>
                ...
                <li class="active"><a href="services_smanager.php">Services</a></li>
                <li><a href="technicians_smanager.php">Technicians</a></li>
                <li><a href="revenue_smanager.php">Revenue</a></li>
                <li><a href="product_main_smanager.php">Products</a>
                    <ul>
...
<div id="container">
    <div class="wrapper">
        <?php //include "tables/product_hardware_table_technician.php"; ?>
        <div id="search">
            <table style="width:400px; margin-left:auto; margin-right:auto;">
                <thead>
                <tr>
                    <th colspan="2">All Services Search</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    ...
                    <td>
                        <select id="date">
                            ...
                            <?php
                                $query = "SELECT DISTINCT DATE_FORMAT(date,'%b %d, %Y'), date
                ...
                <tr>
                    ...
                    <td>
                        <select id="client">
                            <option value=""></option>
                            <?php
                            $query = "SELECT DISTINCT clientID
                                    FROM mgc353_4.Service";
                            $result = mysqli_query($_SESSION['conn'], $query);
                            while($data_row= mysqli_fetch_array($result)){
                                $value = $data_row[0];
                ...
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <button type="button" id="SubmitButton" onclick="searchAllServices()">Search</button>
                    </td>
                </tr>
                </tbody>
            </table>
            <?php //include "searches/product_hardware_search.php"; ?>
        </div>
        <br class="clear" />
        <div id="table"> </div>
    </div>
